...
(defn auto-start!
  "Auto-start services in the background.
...
;; Auto-start services when REPL connects (runs async, won't block jack-in)
;; Comment out the next line if you don't want auto-start:
(auto-start!)
